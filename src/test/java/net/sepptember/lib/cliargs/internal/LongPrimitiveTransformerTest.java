...
class LongPrimitiveTransformerTest {
	...
	public void testTransformThrowsTransformationFailedExceptionWhenGivenArgumentIsNoLong() {
		LongPrimitiveTransformer transformer = new LongPrimitiveTransformer();
		assertAll(
	...
	public void testTransformThrowsTransformationFailedExceptionWhenNullIsGivenAsArgumentList() {
		testTransformOf(new LongPrimitiveTransformer()).with(null).willThrow(TransformationFailedException.class);
	}
